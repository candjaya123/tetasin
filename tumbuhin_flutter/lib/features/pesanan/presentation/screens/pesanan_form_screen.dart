...
class PesananFormScreen extends ConsumerStatefulWidget {
  const PesananFormScreen({super.key});

  @override
  ConsumerState<PesananFormScreen> createState() => _PesananFormScreenState();
}

class _PesananFormScreenState extends ConsumerState<PesananFormScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (_selectedItems.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Pilih minimal satu item')));
      return;
    }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: isSelected ? const Color(0xFFFDB827) : Colors.grey[300]!,
          ),
        ),
        child: Center(
          child: Text(
