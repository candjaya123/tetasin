...
class PesananListScreen extends ConsumerWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/pesanan/new'),
          ),
        ],
      ),
      body: Column(
            ...
            child: ordersAsync.when(
              data: (orders) => orders.isEmpty
                  ? const EmptyStateWidget(
                      ...
                      message:
                          'Histori pesanan Anda akan muncul di sini setelah transaksi dilakukan.',
                    )
                  : AppRefreshIndicator(
                      onRefresh: () async {
      ...
      child: Row(
        children: [
          _FilterChip(
            ...
            onTap: () =>
                ref.read(orderTypeFilterProvider.notifier).state = 'ALL',
          ),
          ...
          _FilterChip(
            ...
            onTap: () =>
                ref.read(orderTypeFilterProvider.notifier).state = 'SO',
          ),
          const SizedBox(width: 10),
          _FilterChip(
            label: 'Pembelian (PO)',
            ...
            onTap: () =>
                ref.read(orderTypeFilterProvider.notifier).state = 'PO',
          ),
        ],
      ),
    );
...
class _OrderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: InkWell(
        onTap: () => context.push('/pesanan/detail', extra: order),
        borderRadius: BorderRadius.circular(24),
        child: Padding(
          padding: const EdgeInsets.all(20),
          child: Column(
