...
final budgetsProvider = FutureProvider.family<List<Map<String, dynamic>>, String>((ref, month) async {
  final service = ref.watch(budgetServiceProvider);
  return await service.getBudgets(month);
});

final budgetSummaryProvider = FutureProvider.family<Map<String, dynamic>, String>((ref, month) async {
