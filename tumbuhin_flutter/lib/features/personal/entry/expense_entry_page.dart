...
class _ExpenseEntryPageState extends ConsumerState<ExpenseEntryPage> {
            ...
            children: [
              ...
              coaAsync.when(
                data: (accounts) {
                  ...
                  final paymentName =
                      _selectedPaymentAccount?['name'] ?? 'Pilih Sumber Dana';
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'Contoh: Bayar listrik, beli kemasan...',
                  border: OutlineInputBorder(borderRadius: Dimens.brMd),
                ),
                maxLines: 2,
              ),
          ...
          builder: (ctx, scrollController) {
            return Column(
              children: [
                ...
                Text(
                  isCategory ? 'Pilih Kategori Pengeluaran' : 'Pilih Rekening',
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final payload = {
        'reference_number': 'EXP-${DateTime.now().millisecondsSinceEpoch}',
